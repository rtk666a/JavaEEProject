...
@WebServlet(value = "/manageNewsPage")
public class manageNewsPageServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/manageNewsPage.jsp").forward(request,response);
    }
